...
const languageStrings = {
    en: {
        translation: {
            ...
            ABOUT: 'City Delhi is a city in india.  A popular destination, City has a rich history of temple and capital of india having awesome enviroment .',
...
const data = {
    ...
    attractions: [
        {
            name: 'Lotus Temple Watching',
            description: 'City has tour boats that depart twice daily from Rogers street at the harbor.  Try either the 7 Seas Whale Watch, or Captain Bill and Sons Whale Watch. ',
            distance: '0',
        },
        {
            name: 'Lotus Temple Watching',
...
const SKILL_NAME = 'City Guide';
const FALLBACK_MESSAGE = `The ${SKILL_NAME} skill can\'t help you with that.  It can help you learn about City if you say tell me about this place. What can I help you with?`;
